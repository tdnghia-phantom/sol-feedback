...
6. **Bật/tắt trang feedback:** Quản lý → **Trang Feedback** → mỗi trang có nút **Bật/Tắt** (có **popup xác nhận**;
   ...
   **bấm vào ô để chọn ngày+giờ bằng lịch** (khung 24h, hiển thị `dd-mm-yy hh:mm`, không gõ tay). Đến giờ hẹn,
   ...
   Bật/Tắt được TÍNH LẠI ngay theo lịch + giờ hiện tại**, và **mỗi lần TẠO hoặc ĐỔI LỊCH đều bắn Telegram**
   (kèm giờ cũ → giờ mới + trạng thái sau khi lưu). Giao diện **chặn ngay** nếu chọn giờ kết thúc trước giờ bắt đầu
   (ô kết thúc bị khoá không cho chọn sớm hơn giờ bắt đầu). Để trống = không tự động.
   *(Đặt giờ tương lai; kiểm tra mỗi 1 tiếng nên tự bật/tắt có thể trễ tối đa ~1 tiếng.)*
